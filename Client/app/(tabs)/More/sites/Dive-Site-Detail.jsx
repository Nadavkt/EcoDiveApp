    ...
    return (
      <View style={styles.container}>
        <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
          ...
          <Text style={styles.headerTitle}>Dive Site</Text>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.siteHeader}>
          <View style={styles.siteIcon}>
            <Ionicons name="location" size={32} color={colors.ocean} />
          </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoItem}>
              <Ionicons name="eye-outline" size={20} color={colors.ocean} />
            ...
            <View style={styles.infoItem}>
              <Ionicons name="person-outline" size={20} color={colors.ocean} />
